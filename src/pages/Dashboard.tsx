import { Calendar, FileText, Vote, CheckSquare, Users, Clock, TrendingUp } from "lucide-react";
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            {pendingVotes.map((vote) => (
              <div key={vote.id} className="p-3 border border-border rounded-lg">
                ...
                <div className="flex items-center justify-between text-sm text-muted-foreground mb-3">
                  ...
                  <span>{vote.votes.yes + vote.votes.no + vote.votes.abstain}/{vote.votes.total} votes</span>
                </div>
                <div className="flex gap-2">
                  <Button size="sm" className="flex-1">Vote</Button>
        ...
        <CardContent>
          <div className="space-y-4">
            {recentActivity.map((activity) => (
              <div key={activity.id} className="flex items-center gap-4 p-3 hover:bg-background-subtle rounded-lg transition-colors">
